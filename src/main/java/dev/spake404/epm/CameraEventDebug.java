...
final class CameraEventDebug {
	...
	static void captureStart(ViewportEvent.ComputeCameraAngles event) {
	...
	static void logEnd(ViewportEvent.ComputeCameraAngles event) {
		if (!EPMConfig.debugCameraEventState()) {
			return;
		}
