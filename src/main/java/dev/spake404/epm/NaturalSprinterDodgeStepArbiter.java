...
final class NaturalSprinterDodgeStepArbiter {
	...
	static boolean tick(Player player) {
	...
	static boolean shouldCancelDodgeStart(Player player) {
	...
	static boolean shouldUseStepOnlyFallback(Player player) {
	...
	static void markDodgeStarted(Player player) {
		State state = STATES.get(player);
		if (state != null) {
