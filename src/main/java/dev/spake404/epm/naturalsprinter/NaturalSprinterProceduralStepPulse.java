...
public final class NaturalSprinterProceduralStepPulse {
	...
	public static void install(AssetAccessor<? extends StaticAnimation> accessor) {
		if (accessor == null) {
	...
	public static void installSustainedFastRunPose(AssetAccessor<? extends StaticAnimation> accessor) {
		if (accessor == null) {
			logInstallSkip("null_accessor", "null", "null");
			return;
		}
	...
	public static void configureSustainedFastRunPose(PlayerPatch<?> playerPatch, NaturalSprinterFastRunAnimationOverrides.RunPoseSettings settings) {
	...
	public static void request(PlayerPatch<?> playerPatch, boolean rightStep) {
	...
	public static void playStepVisualAndAudioEffects(PlayerPatch<?> playerPatch, String source) {
		LivingEntity entity = playerPatch == null ? null : playerPatch.getOriginal();
		if (entity == null) {
			if (debug()) {
	...
	public static void clear(PlayerPatch<?> playerPatch) {
		LivingEntity entity = playerPatch == null ? null : playerPatch.getOriginal();
		clear(entity, "player_patch");
	}

	public static void clear(LivingEntity entity, String source) {
		if (entity != null) {
	...
	public static String debugState(LivingEntity entity) {
		if (entity == null) {
			return "none";
		}
