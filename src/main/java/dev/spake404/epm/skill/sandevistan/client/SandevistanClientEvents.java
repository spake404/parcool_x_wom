...
public final class SandevistanClientEvents {
	...
	public static void clientTick(TickEvent.ClientTickEvent event) {
		...
		SandevistanRenderDiagnostics.tick();
